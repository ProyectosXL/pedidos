        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="action-buttons">
                    ...
                    if ($desde && $hasta) {
                        $backUrl .= "?desde=" . urlencode($desde) . "&hasta=" . urlencode($hasta);
                    }
                    if ($suc) {
                        $backUrl .= ($desde || $hasta ? "&" : "?") . "sucursal=" . urlencode($suc);
                    }
                    ?>
...
<?php
if (empty($detalles)) {
	echo '<div class="alert alert-warning">No se encontraron detalles para el pedido seleccionado.</div>';
} else {
	$totalCantidad = 0;
	...
	<div class="table-container">
		<table id="detalleTable" class="table table-striped table-hover">
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?= htmlspecialchars($v['COD_ARTICU']) ?></td>
						<td><?= htmlspecialchars($v['DESCRIPCIO']) ?></td>
			...
			<tfoot>
				<tr class="table-info">
					<td colspan="3" class="text-end fw-bold">Total de artículos:</td>
					<td class="text-end fw-bold"><?= count($detalles) ?></td>
				</tr>
				<tr class="table-info">
					<td colspan="3" class="text-end fw-bold">Total cantidad:</td>
