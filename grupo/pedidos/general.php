...
<head>
    ...
    <style>
        ...
        /* Centrar los encabezados de la primera fila (FOTO, CODIGO, etc.) */
        #id_tabla thead tr:first-child th {
            text-align: center;
        }
        /* Encabezado agrupador de sucursal (Stock, Vendido, Pedido) */
        ...
        .pedido-input-session-modified {
            background-color: #dcfce7 !important;
            border: 2px solid #16a34a !important;
            box-shadow: 0 0 0 1px #86efac inset;
            font-weight: 700;
        }
        td.pedido-cell-session-modified {
            background-color: #f0fdf4 !important;
        }
        td.pedido-cell-session-modified .pedido-input {
            background-color: #dcfce7 !important;
            border: 2px solid #16a34a !important;
            font-weight: 700;
        }
        ...
        .importe-summary-expanded .input-group {
            max-width: 180px !important;
        }
        .importe-summary-expanded #totalPrecio {
            min-width: 110px;
            text-align: center;
        }
        #totalSKU {
    ...
    <div class="fixed-header">
        <div class="container-fluid">
            <div class="row align-items-center flex-nowrap">
                ...
                <div class="col-auto unid-summary-hidden">
                ...
                <thead class="table-fixed-header">
                    <tr>
                        ...
                        <?php foreach ($sucursalesActivasInfo as $suc => $info): ?>
                            <th colspan="3" class="sucursal-header"><?= htmlspecialchars($info['nombreCompleto']) ?></th>
                        <?php endforeach; ?>
                        <th data-bs-toggle="tooltip" data-bs-placement="top" title="Precio unitario">PRECIO</th>
                    </tr>
                    <tr>
                        <th></th>
                        <th></th>
                ...
                <tbody id="tabla">
                    ...
                    ?>
                        <tr <?= $isSale ? 'style="font-weight:bold;color:#FE2E2E"' : '' ?>>
                            ...
                            <td id="precio"><?= (int)($v['PRECIO'] ?? 0) ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
                <tfoot>
